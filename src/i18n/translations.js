...
export const translations = {
  en: {
    ...
    startupDreams: {
      ...
      cards: [
        { img: 'fix-the-mess.webp', title: 'Fix the Mess', desc: 'Stop using duct-tape and hope. We replace broken links with custom code that just works.' },
        { img: 'startup_plan.webp', title: 'From 2 Weeks to 3 Days', desc: 'We cut onboarding by 80%. What used to take weeks of manual work now happens in days.' },
        ...
        { img: 'weve-been-there.webp', title: 'We\'ve Been There', desc: 'We know the pain of slow operations. We know exactly what to fix and how to do it without the high price tag.' },
        { img: 'more-growth.webp', title: 'More Growth, Less Work', desc: 'Grow your business without hiring more people to do boring stuff. Our tools do the busywork for you.' },
        { img: 'built-for-long-run.webp', title: 'Built for the Long Run', desc: "Focus on your big ideas. We'll make sure the background stuff is solid and ready to grow with you." },
      ],
      banner: {
  ...
  nl: {
    ...
    startupDreams: {
      ...
      cards: [
        { img: 'fix-the-mess.webp', title: 'Ruim de Rommel Op', desc: 'Stop met houtje-touwtje oplossingen. Wij vervangen kapotte koppelingen door code die gewoon werkt.' },
        { img: 'startup_plan.webp', title: 'Van 2 Weken naar 3 Dagen', desc: 'We verkortten de onboarding met 80%. Wat eerst weken handmatig werk was, gebeurt nu in een paar dagen.' },
        ...
        { img: 'weve-been-there.webp', title: 'We Kennen de Pijn', desc: 'We weten hoe frustrerend trage processen zijn. We weten precies wat we moeten fixen, zonder de hoofdprijs.' },
        { img: 'more-growth.webp', title: 'Meer Groei, Minder Werk', desc: 'Schaal je bedrijf zonder extra mensen aan te nemen voor saai werk. Onze tools doen het werk voor je.' },
        { img: 'built-for-long-run.webp', title: 'Klaar voor de Toekomst', desc: "Focus op je grote ideeën. Wij zorgen dat alles op de achtergrond staat als een huis en met je meegroeit." },
      ],
      banner: {
