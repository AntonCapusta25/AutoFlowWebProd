    ...
    <main className="main-content policy-page">
      <div className="container" style={{maxWidth:'800px',padding:'120px 20px 80px'}}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '32px' }}>
          ...
          <h1 style={{color:'#F8FAFC',margin:0}}>Privacy Policy</h1>
        </div>
        <div style={{color:'#94A3B8',lineHeight:1.8,fontSize:'0.95rem'}}>
          ...
          <p>For any privacy concerns, contact us at <a href="mailto:info@autoflowstudio.net" style={{color:'#d1bbfb'}}>info@autoflowstudio.net</a>.</p>
        </div>
      </div>
    </main>
  )
