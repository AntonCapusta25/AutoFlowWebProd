  ...
  return (
    <div className="cookies-banner" style={{
      ...
      <p style={{color:'#94A3B8',fontSize:'0.875rem',lineHeight:1.6,margin:0}}>
        ...
        <a href="/cookie-policy" style={{color:'#d1bbfb'}}>Cookie Policy</a>.
      </p>
      <div style={{display:'flex',gap:'12px'}}>
        <button onClick={accept} style={{flex:1,padding:'10px',borderRadius:'8px',border:'none',background:'linear-gradient(135deg,#d1bbfb,#a78bfa)',color:'white',fontWeight:600,cursor:'pointer',fontSize:'0.875rem'}}>
          Accept
        </button>
