    ...
    <div style={bannerContainerStyle}>
      <div className="promo-content" style={contentStyle}>
        ...
        <div className="promo-badge-container" style={badgeContainerStyle}>
          ...
          <span className="promo-badge-text" style={badgeTextStyle}>LIMITED SPOTS</span>
        </div>

        {/* Message & Timer */}
        <div style={timerContainerStyle}>
          <span className="promo-msg" style={msgStyle}>PRICE INCREASING SOON!</span>
          <span className="promo-timer" style={timerBoxStyle}>{timeLeft}</span>
        </div>

        {/* CTA & Close */}
        <div className="promo-actions" style={actionsStyle}>
          <button onClick={onCTA} className="promo-cta" style={ctaStyle}>
            GET AUDIT
